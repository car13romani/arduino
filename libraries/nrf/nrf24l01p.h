...
#ifndef NRF24L01P_H__
#define NRF24L01P_H__
...
typedef enum
{
    NRF24L01P_SPI_SS_LOW = 0,
    NRF24L01P_SPI_SS_HIGH = 1
} nrf24l01p_spi_ss_level_t;
 ...
 */
void nrf24l01p_lock_unlock(void);
 ...
 */
uint8_t nrf24l01p_read_rx_fifo_payload_width(void);
...
*/
bool nrf24l01p_get_irq_mode(nrf24l01p_irq_source_t int_source);

/** Read all interrupt flags.
 * Use this function to get the interrupt flags. This function is similar
 * to nrf24l01p_get_clear_irq_flags with the exception that it does <I><B>NOT</B></I> clear
 * the irq_flags.
 *
 * @return Interrupt_flags
 * @retval 0x10 Max Retransmit interrupt
 ...
 * <I>length</I> number of bytes, which are stored in <I>*tx_payload</I>.
 *
...
/* nrf24l01p_l01 basic functions, used by all the other functions */
 ...
 *
 * @return pipe# of received data (MSB), if operation used by a nrf24l01p_read_rx_payload
 * @return length of read data (LSB), either for nrf24l01p_read_rx_payload or
 * for nrf24l01p_get_address.
*/
