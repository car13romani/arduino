...
/*
//estacao meteorologica joao
uint8_t const SOFT_SPI_MOSI_PIN = 4;
uint8_t const SOFT_SPI_MISO_PIN = 5;
uint8_t const SOFT_SPI_SCK_PIN = 6;
*/

/*estacao meteorologica romani
uint8_t const SOFT_SPI_MOSI_PIN = 16;
uint8_t const SOFT_SPI_MISO_PIN = 15;
uint8_t const SOFT_SPI_SCK_PIN = 14;
*/
/*/estacao meteorologica Cleber
uint8_t const SOFT_SPI_MOSI_PIN = 50;
uint8_t const SOFT_SPI_MISO_PIN = 51;
uint8_t const SOFT_SPI_SCK_PIN = 52;
*/

//normal
uint8_t const SOFT_SPI_MOSI_PIN = 15;
uint8_t const SOFT_SPI_MISO_PIN = 16;
uint8_t const SOFT_SPI_SCK_PIN = 14;
