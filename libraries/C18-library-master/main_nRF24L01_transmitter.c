/* 
 * File:   main_nRF24L01_transmitter.c
 * Author: Vinh
 *
 * Created on Ngày 10 tháng 9 năm 2012, 16:50
 */
...
void main(void)
{
    ...
    LATD = 0;
    Delay10KTCYx(255);
    NRF24_WriteByte(W_REGISTER | CONFIG, 0b00001110);
    DELAY_2MS;
    ...
    */
    while(1)
    {
        ...
        {
            value++;
            NRF24_WriteByte(W_TX_PAYLOAD, value);
            NRF24_Transmit();
            while ( !(NRF24_IRQActive() && (NRF24_Check_DataSent() || NRF24_Check_MaxRetry())) );
                NRF24_Clear_Status();
